...
public class BlueFragment extends Fragment {
    public static final String STRING_TAG=BlueFragment.class.getSimpleName();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        button = getActivity().findViewById(R.id.btnBlue);
        editText=getActivity().findViewById(R.id.etBlue);
