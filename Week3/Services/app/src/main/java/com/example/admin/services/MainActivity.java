...
import com.example.admin.services.Services.MyNewProcessService;
import com.example.admin.services.Services.MyService;
...
boolean isBound;
    ...
    public void onStartedServices(View view) {
        ...
        serviceIntent.putExtra("data","Data from main activitiy");
...
isBound=true;
    ...
    public void onScheduleJob(View view) {
        ...
        JobInfo.Builder builder =new JobInfo.Builder(JOB_ID_NORMAL_SERVICE,componentName)
                .setRequiresDeviceIdle(true).setOverrideDeadline(5000);
    ...
    public void onNewProcess(View view) {
